...
var dashboard_query = "SELECT distinct CM_CP_ID,CM_CP_NAME,CM_ULT_PARNT_NAME,CM_CRNT_OBLI_RATING,CM_CRNT_SHORT_SCORE,CM_PREV_OBLI_RATING,CM_PREV_CLTRL_RATING,CM_CRNT_CLTRL_RATING,CM_CRNT_MR_IR,CM_PREV_MR_IR,CM_LAST_REFRESH_TIME FROM COUNTERPARTY_MASTER ORDER BY CM_CP_NAME";
...
var IR_Query = "SELECT PR_CP_ID,PR_RATING_MR_AND_IR,PR_TRANSITION_MR_AND_IR,PR_DRIVERS_OF_CHANGE_MR_AND_IR,PR_HIGHEST_CHANGE_MR_AND_IR,PR_MR_AND_IR_BREACHED,PR_CRAWLING_DATE FROM PORTFOLIO_LEVEL where PR_CP_ID = 'C27'";
var IR_Query_desc = "SELECT PR_CP_ID,PR_RATING_MR_AND_IR,PR_TRANSITION_MR_AND_IR,PR_DRIVERS_OF_CHANGE_MR_AND_IR,PR_HIGHEST_CHANGE_MR_AND_IR,PR_MR_AND_IR_BREACHED,PR_CRAWLING_DATE FROM PORTFOLIO_LEVEL where PR_CP_ID = 'C27' ORDER BY PR_CRAWLING_DATE DESC LIMIT 2";
var IR_Query_max = "SELECT * FROM PORTFOLIO_LEVEL WHERE PR_RATING_MR_AND_IR= (SELECT MAX(PR_RATING_MR_AND_IR) FROM PORTFOLIO_LEVEL WHERE PR_CP_ID = 'C27') LIMIT 1";
